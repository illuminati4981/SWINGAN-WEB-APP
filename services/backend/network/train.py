...
def setup_training_loop_kwargs(
    ...
    if cfg == 'auto':
        ...
        spec.lrate = 0.002
        # spec.lrate = 0.0025   For ffhq resume
    ...
    args.Swin_opt_kwargs = dnnlib.EasyDict(class_name='torch.optim.Adam', lr=spec.lrate, betas=[0,0.99], eps=1e-8, weight_decay=1e-4)
    args.G_opt_kwargs = dnnlib.EasyDict(class_name='torch.optim.Adam', lr=spec.lrate, betas=[0,0.99], eps=1e-8, weight_decay=1e-4)
    args.D_opt_kwargs = dnnlib.EasyDict(class_name='torch.optim.Adam', lr=spec.lrate / 10, betas=[0,0.99], eps=1e-8, weight_decay=1e-4)
